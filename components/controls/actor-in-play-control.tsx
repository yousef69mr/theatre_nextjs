    ...
    <div className="mt-6 border rounded-md p-4 space-y-2">
            ...
            <CommandList>
              ...
              >
                {actorInPlayList.map((actorInPlay) => (
                  <CommandItem key={actorInPlay.id}>
                    <ActorInPlayCard
                      key={actorInPlay.id}
                      actorInPlay={actorInPlay}
                      mode="search"
                    />
                  </CommandItem>
                ))}
      ...
      <div
        className={cn(
          ...
          actorInPlayList.length > 0 && "justify-start flex-wrap gap-3 py-1"
        )}
      >
...
export default ActorInPlayControl;
